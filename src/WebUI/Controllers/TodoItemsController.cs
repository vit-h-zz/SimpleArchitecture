...
using SimpleArchitecture.Application.TodoItems.Commands.UpdateTodoItemDetail;
using SimpleArchitecture.Application.TodoItems.Queries.GetTodoItemsWithPagination;
